...
//       <div className="flex items-center clip-diamond mt-16">
//         <h1 className="w-44 text-xl font-bold mb-4 ml-8 px-6 text-white">Brands We Help to Build</h1>
...
//               className="flex items-center justify-center w-40 h-20 object-contain bg-white rounded-md clip-path-sim animate-slideLeft"
//             />
//           ))}
//         </div>
//       </div>
...
import client1 from "../assets/Cadbury-Logo-600x400.png.webp";
import client2 from "../assets/Citibank-Logo-600x400.png.webp";
import client3 from "../assets/Dior-Logo-600x400.png.webp";
import client4 from "../assets/IBM-Logo-600x400.png.webp";
import client5 from "../assets/Louis-Vuitton-Logo-600x400.png.webp";
import client6 from "../assets/Royal-Bank-of-Canada-Logo-600x400.png.webp";
import client7 from "../assets/Shein-Logo-600x400.png.webp";
import client8 from "../assets/Societe-Generale-Logo-600x400.png.webp";
import client9 from "../assets/Supreme-Logo-600x400.png.webp";
import client10 from "../assets/Walmart-Logo-600x400.png.webp";
